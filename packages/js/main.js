...
resumeLink.addEventListener("click", function (event) {
  ...
  window.open(
    "https://drive.google.com/file/d/1hBNfXcrx1sdpdjHbvFOurj6znJx_TQr2/view?usp=drive_link",
    "_blank"
  )
  let link = document.createElement("a")
  link.href =
    "https://drive.google.com/uc?export=download&id=1hBNfXcrx1sdpdjHbvFOurj6znJx_TQr2"
